class CambioComisionRegistro < ApplicationRecord
  ...
  when /^created_at_/
    ...
    order("cambio_comision_registros.created_at #{ direction }")
  when /^apellido_/
    # Simple sort on the name colums
    order("LOWER(cambio_comision_registros.user.paterno) #{ direction }, LOWER(cambio_comision_registros.user.materno) #{ direction }")
  else
